...
export function KatalogFilterBar({
  ...
  return (
    <div className="bg-white p-4 border-2 border-blue-900 shadow-[4px_4px_0px_#1E3A8A] rounded-xl flex flex-col md:flex-row gap-3 items-end relative z-20">
      {/* SEARCH INPUT */}
      ...
      {/* DROPDOWN FILTERS */}
      <div className="w-full md:w-auto flex flex-col sm:flex-row items-end gap-2.5">
