      ...
      <AlertDialogContent className="border-2 border-blue-900 [box-shadow:6px_6px_0px_#1E3A8A] rounded-lg">
        <AlertDialogHeader>
          <AlertDialogTitle className="flex items-center gap-2 text-red-600 font-black text-lg">
            ...
            Konfirmasi Reset Sandi Akun
          </AlertDialogTitle>
          <AlertDialogDescription className="text-slate-700 pt-2 font-medium space-y-3">
            <p>
              Apakah Anda yakin ingin mereset kata sandi untuk mahasiswa{" "}
              <strong>{user.name}</strong> (NIM:{" "}
            ...
            <div className="p-3 bg-red-50 border-2 border-red-200 rounded-md text-xs text-red-800 font-semibold flex items-start gap-2">
              ...
              <span>
                Sandi akan dikembalikan ke sandi standar (
                <code className="bg-white px-1.5 py-0.5 border border-red-300 rounded font-black text-red-900">
                  123456
                </code>
                ). Pengguna akan diminta mengganti sandi saat login berikutnya.
              </span>
            </div>
          </AlertDialogDescription>
        </AlertDialogHeader>
