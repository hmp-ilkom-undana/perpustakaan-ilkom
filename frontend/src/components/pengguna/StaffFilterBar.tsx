...
import type { StaffStatusFilter } from "@/hooks/useAdminPetugas";
  ...
  return (
    <div className="p-4 sm:p-5 border-b-2 border-blue-900 bg-slate-50/70 flex flex-col md:flex-row gap-3 items-stretch md:items-center justify-between">
      ...
      <div className="flex items-center gap-3 flex-wrap">
        ...
        {/* Action Button: Tambah Petugas */}
        <Button
          onClick={onOpenCreate}
          className="bg-orange-500 hover:bg-orange-600 text-white font-bold border-2 border-blue-900 shadow-[3px_3px_0px_#1E3A8A] active:translate-x-[2px] active:translate-y-[2px] active:shadow-none rounded-md transition-all flex items-center gap-2 cursor-pointer h-10 px-4"
        >
