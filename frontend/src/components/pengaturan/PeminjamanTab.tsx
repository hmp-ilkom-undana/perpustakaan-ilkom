      ...
      <Card className="border-2 border-blue-900 shadow-[4px_4px_0px_#1E3A8A] bg-white">
        <CardContent className="p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
            {/* Skripsi */}
            <div className="p-4 border-2 border-blue-900 rounded-lg bg-orange-50/50 shadow-[3px_3px_0px_#1E3A8A] space-y-2">
            ...
            {/* Ringkasan Skripsi */}
            <div className="p-4 border-2 border-blue-900 rounded-lg bg-amber-50/50 shadow-[3px_3px_0px_#1E3A8A] space-y-2">
              <div className="flex items-center justify-between">
            ...
            {/* Naskah Publikasi */}
            <div className="p-4 border-2 border-blue-900 rounded-lg bg-blue-50/50 shadow-[3px_3px_0px_#1E3A8A] space-y-2">
              <div className="flex items-center justify-between">
