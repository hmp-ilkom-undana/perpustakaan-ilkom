        ...
        <div className="flex flex-col gap-4">
          <div className="space-y-2">
            ...
            <select
              ...
              onChange={(e) => onReturnConditionChange(e.target.value as ReturnCondition)}
            ...
            >
              <option value="BAIK">Bagus / Baik (Lengkap)</option>
              <option value="RUSAK">Rusak (Halaman Robek / Cacat)</option>
            ...
            {returnCondition !== "BAIK" && (
              <div className="animate-in slide-in-from-top-1 fade-in mt-2">
                <textarea
                  ...
                  placeholder="Tuliskan catatan kerusakan atau kronologi kehilangan arsip..."
